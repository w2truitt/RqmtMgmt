...
namespace backend.Migrations
{
    ...
    [Migration("20251007165138_EnforceSectionHierarchy")]
    partial class EnforceSectionHierarchy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.DocumentSection", b =>
                {
                    ...
                    b.HasIndex("ParentSectionId", "SectionOrder")
                        .HasDatabaseName("IX_DocumentSections_ParentSectionId_SectionOrder");

                    b.ToTable("DocumentSections", t =>
                        {
                            t.HasCheckConstraint("CK_DocumentSection_ParentReference", "([DocumentId] IS NOT NULL) OR ([ParentSectionId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.DocumentSection", b =>
                {
                    ...
                    b.HasOne("backend.Models.DocumentSection", "ParentSection")

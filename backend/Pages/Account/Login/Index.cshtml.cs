...
public class Index : PageModel
{
    ...
    private async Task BuildModelAsync(string? returnUrl)
    {
        ...
        var providers = schemes
            ...
            .Select(x => new ViewModel.ExternalProvider(x.Name, x.DisplayName ?? x.Name)).ToList();

        var dynamicSchemes = (await _identityProviderStore.GetAllSchemeNamesAsync())
            .Where(x => schemes.All(y => y.Name != x.ToString()))
            .Select(x => new ViewModel.ExternalProvider(x.ToString(), x.ToString()));
